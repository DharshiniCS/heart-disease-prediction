...
class echo_image_classify:
    ...
    def home_window(self):
        ...
        text_title = canvas.create_text(260, 100, text="SELECT IMAGE(ECHO)", font=("Times New Roman", 20), fill=self.text_color)
        blink_text()
        ...
        def select_image():
            ...
            echo_image_classify.path = file_path
            ...
            canvas.itemconfig(text_title, text="IMAGE ACQUISITION(ECHO)")
        ...
        def morphological():
            ...
            nn = FE([2, 2, 1])
            nn.glcm_extract(z)
            echo_image_classify.f_value = nn.result()
        ...
        def feature_extraction():
            ...
            feature = canvas.create_text(260, 450, text="Feature : "+str(echo_image_classify.f_value), font=("Times New Roman", 20),fill=self.text_color)
        ...
        def training():
            ...
            def exit_program():
                ...
                if (disease == ""):
                    ...
                    msg = write_dataset(disease=disease, value=echo_image_classify.f_value,Stage=Stage,treatment=treatment,mortality=mortality)
        ...
        def testing():
            ...
            with open(file1) as f:
                ...
                for row in reader:
                    t1 = row['value']
                    t2 = row['label']
                    if int(echo_image_classify.f_value) == int(t1):
                        result=t2
                        stage = row['stage']
            ...
            echo_image_classify.e1.append(etime)
            index=echo_image_classify.f_value
            ####################################
            ...
            features.append(float(echo_image_classify.f_value))
            ...
            echo_image_classify.e1.append(duration_time)
            echo_image_classify.e1.sort(reverse=True)
            ...
            data = [echo_image_classify.e1[0], echo_image_classify.e1[1]]
            lables = ['Existing', 'Proposed']
