...
class ecg_image_classify1:
    ...
    def home_window(self):
        ...
        text_title = canvas.create_text(450, 100, text="SELECT IMAGE(ECG)", font=("Times New Roman", 20), fill=self.text_color)
        blink_text()
        ...
        def select_image():
            ...
            ecg_image_classify1.path = file_path
        ...
        def training():
            ...
            def exit_program():
                ...
                if (disease == ""):
                    ...
                    msg = write_dataset(disease=disease, value=ecg_image_classify1.f_value,Stage=Stage,treatment=treatment,mortality=mortality)
        ...
        def testing():
            ...
            nn = FE([2, 2, 1])
            nn.glcm_extract(z)
            ecg_image_classify1.f_value = nn.result()
            ################################################
            ...
            with open(file1) as f:
                ...
                for row in reader:
                    t1 = row['value']
                    t2 = row['label']
                    if int(ecg_image_classify1.f_value) == int(t1):
                        result=t2
                        stage = row['stage']
            ...
            ecg_image_classify1.e1.append(etime)
            index=ecg_image_classify1.f_value
            ####################################
            ...
            features.append(float(ecg_image_classify1.f_value))
            ...
            ecg_image_classify1.e1.append(duration_time)
            ecg_image_classify1.e1.sort(reverse=True)
            ...
            data = [ecg_image_classify1.e1[0], ecg_image_classify1.e1[1]]
            lables = ['Existing', 'Proposed']
